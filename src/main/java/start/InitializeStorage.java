...
public class InitializeStorage {
    ...
    private final static boolean includeCompressed = false;
    private final static String outPutDirName = "bioportal";
    private final String baseDir = "/home/ahmed/";
    ...
    private ArrayList<Integer> verticesID = new ArrayList();
    private HashMap<Integer, VertexGraph> verticies = new HashMap<>();
    private Dictionary dictionary;
    private Dictionary reverseDictionary;
    ...
    private static ArrayList<String> printBuffer;
    ...
    private int toBigListDetected = 0;
    ...
    private ArrayList<Triple> fullTempList = new ArrayList<>();
    ...
    private void setBorderVertices() {
        ...
        for (int i = 0; i < verticesID.size(); i++) {
            int sp = verticies.get(verticesID.get(i)).partitionNumber;
            ArrayList<Vertex> ves = graph.get(verticesID.get(i));
    ...
    private void writeFile(boolean weighting) {
        ...
        try {
            ...
            bw.write(verticesID.size() + " " + edgesCount + " 001");
            bw.newLine();
            for (int i = 0; i < verticesID.size(); i++) {
                ArrayList<Vertex> ves = graph.get(verticesID.get(i));
                String str = buildVertixString(ves, verticesID.get(i), weighting);
      /*      if (str.matches("")){
        ...
        if (linesWrittenCount != verticesID.size() || edgesWritten != 2 * edgesCount) {
    ...
    public void printTransporterSummary() {
        transporter.printSummary();
    }



    public StarterGUI startGUI(){
