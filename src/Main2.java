...
//        ArrayList<Vertex> vv = graph.get(vertecesID.get(3));
    ...
    private Main2.MyHashMap<String, ArrayList<Triple>> sp_O;
    ...
    private Main2.MyHashMap<String, ArrayList<Triple>> op_S;
    ...
    private void addToIndex(Main2.MyHashMap<String, ArrayList<Triple>> index , Triple triple , String key){
    ...
    private class MyHashMap<K, V> extends HashMap<K, V> implements Serializable {
